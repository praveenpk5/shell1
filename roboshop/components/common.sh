...
SystemdD_Setup() {
  ...
  sed -i -e 's/MONGO_DNSNAME/mongodb.roboshop.int/' -e 's/REDIS_ENDPOINT/redis.roboshop.int/' -e  's/MONGO_ENDPOINT/mongodb.roboshop.int/' -e 's/CATALOGUE_ENDPOINT/catalogue.roboshop.int/' -e 's/CARTENDPOINT/cart.roboshop.int/' -e 's/DBHOST/mysql.roboshop.int/' -e 's/CARTHOST/cart.roboshop.int/' -e 's/USERHOST/user.roboshop.int/' -e 's/AMQPHOST/rabbitmq.roboshop.int/'  /home/roboshop/${COMPONENT}/systemd.service
  Status_Check $?
